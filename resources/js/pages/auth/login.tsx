    ...
    return (
        <>
            ...
            <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-50 px-4 py-10 dark:bg-[#0F1117]">
                ...
                {/* Waveform / ECG line decorative SVG */}
                <div
                                ...
                                <>
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        <Checkbox
                                            ...
                                            name="remember"
                                            tabIndex={3}
                                            className="rounded-md border-gray-300 dark:border-zinc-600"
                                        />
                                        <Label
                                            htmlFor="remember"
                                    ...
                                    <Button
                                        type="submit"
                                        className="h-11 w-full rounded-xl bg-blue-600 text-sm font-bold text-white shadow-md shadow-blue-200/60 transition-all duration-200 hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-200/80 active:scale-[0.98] disabled:opacity-70 dark:shadow-blue-900/30 dark:hover:shadow-blue-900/50"
                                        tabIndex={4}
                                        disabled={processing}
