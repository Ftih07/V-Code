...
export default function RecordSummary({ sessionData }: any) {
    ...
    return (
        <div className="relative flex min-h-screen items-start justify-center bg-slate-100 px-0 py-0 dark:bg-zinc-950 md:bg-slate-200/60 md:py-8">
            ...
            <div className="absolute top-1/4 left-1/2 -z-10 h-72 w-72 -translate-x-1/2 rounded-full bg-blue-400/20 blur-3xl hidden md:block" />
            ...
            <div className="flex w-full max-w-md min-h-screen md:min-h-[800px] md:max-h-[92vh] flex-col bg-slate-50 dark:bg-zinc-950 md:rounded-3xl md:border md:border-slate-200/80 dark:md:border-zinc-800 md:shadow-2xl overflow-hidden">
                ...
                <div className="sticky top-0 z-10 flex items-center justify-between bg-gradient-to-r from-blue-900 to-indigo-900 p-4 text-white shadow-md md:rounded-t-2xl">
                    ...
                    <h1 className="text-base font-bold tracking-wider">V-CODE</h1>
                    ...
                    <div className="flex flex-col items-center text-center pb-6">
                        <div className="relative mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-emerald-50 dark:bg-emerald-950/30">
                            ...
                            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 shadow-md shadow-emerald-200 dark:shadow-none">
                                <svg className="h-7 w-7 text-white" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24">
                        ...
                        <p className="mt-1 text-xs font-medium text-emerald-600 bg-emerald-50 dark:bg-emerald-950/40 dark:text-emerald-400 px-3 py-1 rounded-full border border-emerald-100 dark:border-emerald-900/30">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="flex justify-between items-center py-0.5">
                                    ...
                                    <span className="font-mono font-semibold text-gray-900 dark:text-zinc-100">
                                        {new Date(sessionData.start_time).toLocaleTimeString('id-ID', {
                                            hour: '2-digit',
                                            minute: '2-digit',
                                            second: '2-digit'
                                        })}
                                ...
                                <div className="flex justify-between items-center py-0.5 border-t border-gray-50 dark:border-zinc-800/50">
                                    <span className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                                        <span>⏳</span> Durasi Rekam
                                    </span>
                                    <span className="font-mono font-semibold text-gray-900 dark:text-zinc-100">
                                        {Math.floor(sessionData.duration_seconds / 60).toString().padStart(2, '0')}
                                        :
                                        {(sessionData.duration_seconds % 60).toString().padStart(2, '0')}
                                    </span>
                                </div>
                                <div className="flex justify-between items-center py-0.5 border-t border-gray-50 dark:border-zinc-800/50">
                                    <span className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                        ...
                        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="flex items-start justify-between py-0.5">
                                    <span className="w-28 shrink-0 text-gray-500 dark:text-gray-400 font-medium">
                                        Leader Tim
                                    </span>
                                ...
                                <div className="flex items-start justify-between py-0.5 border-t border-gray-50 dark:border-zinc-800/50">
                                    <span className="w-28 shrink-0 text-gray-500 dark:text-gray-400 font-medium">
                                        Dokumentator
                                    </span>
                                    <span className="text-right font-semibold text-gray-900 dark:text-zinc-100">
                                ...
                                <div className="flex items-start justify-between py-0.5 border-t border-gray-50 dark:border-zinc-800/50">
                                    ...
                                    <span className="text-right font-medium text-gray-600 dark:text-zinc-400 leading-relaxed max-w-[200px]">
